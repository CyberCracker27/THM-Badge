...
The Firefox extension source code is maintained separately:

**THM Badge Extension:**  
https://github.com/CyberCracker27/THM-Badge-Extension
...
1. Open the **THM Badge GitHub App**:
   https://github.com/apps/thm-badge
2. Click **Install / manage GitHub App** in the extension when available.
3. Select the repository you want to use.
4. Install the THM Badge GitHub App.
5. Return to the extension.
6. Refresh/select the repository.
...
Then install it for the required repository, return to the extension, and refresh the repository list.
